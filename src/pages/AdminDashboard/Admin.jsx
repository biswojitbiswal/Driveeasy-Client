...
const AdminDashboard = () => {
    ...
    const sidebarItems = [
        ...
        { id: 'vehicles', label: 'Vehicle', icon: Car, component: AdminVehicle },
        { id: 'orders', label: 'Orders', icon: ShoppingCart, component: AdminOrder },
        { id: 'users', label: 'Users', icon: Users, component: AdminUser },
        { id: 'agents', label: 'Agents', icon: UserCheck, component: AdminAgent },
        { id: 'settings', label: 'Settings', icon: Settings, component: AdminSetting },
    ];

    const getCurrentUrl = () => {
        return `/admin/${activeTab}`;
    };
                ...
                <div className="p-6 border-b border-gray-200">
                    <div className="flex items-center justify-center lg:justify-start">
                        <div className="bg-orange-600 rounded-lg flex items-center justify-center">
                            <Shield className="w-8 h-8 mx-2 my-2 text-white" />
                        </div>
                        <span className="hidden lg:block ml-3 text-xl font-bold text-gray-900">Admin</span>
                    </div>
                </div>
