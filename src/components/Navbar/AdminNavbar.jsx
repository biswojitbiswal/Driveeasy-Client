...
import { Car, ChevronDown, User, LogOut, Menu, X, Settings, Bell } from 'lucide-react'
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        <span className="hidden sm:block text-sm text-gray-500 ml-2">Admin Panel</span>
                    </div>
                                    ...
                                    <div className="absolute right-0 mt-2 w-64 bg-white rounded-lg shadow-lg border border-gray-200 py-2">
                                        <div className="px-4 py-3 border-b border-gray-100">
                                            <div className="flex items-center space-x-3">
                                                ...
                                                <div>
                                                    <div className="font-medium text-gray-900">{user?.firstName || 'Admin Name'}</div>
                                                    <div className="text-sm text-gray-500">{user?.email || 'admin@driveeasy.com'}</div>
                                                </div>
                                            </div>
                                        </div>
                ...
                {isMobileMenuOpen && (
                    <div className="md:hidden bg-white border-t border-gray-200">
                        <div className="px-2 pt-2 pb-3 space-y-1">
                            ...
                            <NavLink to="/admin/profile" className="block px-3 py-2 text-gray-600 hover:text-orange-600">
                                Profile Settings
                            </NavLink>
                            <NavLink to="/admin/settings" className="block px-3 py-2 text-gray-600 hover:text-orange-600">
                                System Settings
                            </NavLink>
                            <div
